...
!(function (e, t) {
    ...
    function ie(e, t, s) {
        ...
        let r = i.children(`.${a}`);
        return r.length || ((r = d(`<div class="tajawal_black swiper-slide-shadow${s ? `-${s}` : ""}"></div>`)), i.append(r)), r;
    }
    ...
    const re = [
        function (e) {
            ...
            function n(e, t) {
                ...
                const i = a.renderSlide ? d(a.renderSlide.call(s, e, t)) : d(`<div class="tajawal_black ${s.params.slideClass}" data-swiper-slide-index="${t}">${e}</div>`);
        ...
        function (e) {
            ...
            function u() {
                ...
                if ("bullets" === e.type) {
                    ...
                    for (let s = 0; s < i; s += 1) e.renderBullet ? (r += e.renderBullet.call(t, s, e.bulletClass)) : (r += `<${e.bulletElement} class="tajawal_black ${e.bulletClass}"></${e.bulletElement}>`);
        ...
        function (e) {
            ...
            function T() {
                ...
                0 === r.length && ((r = d(`<div class="tajawal_black ${t.params.scrollbar.dragClass}"></div>`)), i.append(r)),
        ...
        function (e) {
            ...
            a("beforeInit", () => {
                i = d(`<span class="tajawal_black ${t.params.a11y.notificationClass}" aria-live="assertive" aria-atomic="true"></span>`);
            }),
                a("afterInit", () => {
        ...
        function (e) {
            ...
            const i = (e, t, s) => {
                ...
                0 === a.length && ((a = d(`<div class="tajawal_black swiper-slide-shadow-${s ? "left" : "top"}"></div>`)), e.append(a)),
                    0 === i.length && ((i = d(`<div class="tajawal_black swiper-slide-shadow-${s ? "right" : "bottom"}"></div>`)), e.append(i)),
            ...
            te({
                ...
                setTranslate: () => {
                    ...
                    p.shadow &&
                        (u
                            ? ((m = s.find(".swiper-cube-shadow")), 0 === m.length && ((m = d('<div class="tajawal_black swiper-cube-shadow"></div>')), s.append(m)), m.css({ height: `${r}px` }))
                            : ((m = e.find(".swiper-cube-shadow")), 0 === m.length && ((m = d('<div class="tajawal_black swiper-cube-shadow"></div>')), e.append(m))));
                    for (let e = 0; e < a.length; e += 1) {
                        const t = a.eq(e);
                        let s = e;
